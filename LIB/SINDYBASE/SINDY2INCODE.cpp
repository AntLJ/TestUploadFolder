...
SINDY2INCODE::Code SINDY2INCODE::link_class[] = {
	...
	{sindy::road_link::linkclass_roundabout,	in::road::link_class::roundabout},
	{-1, -1}
};
...
SINDY2INCODE::Code SINDY2INCODE::road_class[] = {
	...
	{sindy::road_link::roadclass_highway2,		in::road::road_class::highway2},
	...
	{sindy::road_link::roadclass_match2,		in::road::road_class::dummy_link5},
	{-1, -1}
};
...
SINDY2INCODE::Code SINDY2INCODE::wide_area[] = {
	{0,		in::road::wide_area::not_wide_area},
	{1,		in::road::wide_area::wide_area},
	{-1, -1}
};
...
SINDY2INCODE::Code SINDY2INCODE::segment_attr[] = {
	...
	{sindy::segment_attr::linkattr_dirtroad,	in::road::segment_attr::dirtroad},
	{sindy::segment_attr::linkattr_tunnel_square,	in::road::segment_attr::tunnel},		// 車種別規制　IN変換丸め込み　トンネル(四角)⇒トンネル
	{sindy::segment_attr::linkattr_tunnel_circle,	in::road::segment_attr::tunnel},		// 車種別規制　IN変換丸め込み　トンネル(丸)⇒トンネル
	{sindy::segment_attr::linkattr_crossing_kamaboko,	in::road::segment_attr::crossing},	// 車種別規制　IN変換丸め込み　踏切(かまぼこ型)⇒踏切
	{-1, -1}
};
...
SINDY2INCODE::Code SINDY2INCODE::area_flag[] = {
	...
	{sindy::road_link::alleymainte_2005,			in::road::area_flag::year_2005},
	{sindy::road_link::alleymainte_2006,			in::road::area_flag::year_2006},
	{sindy::road_link::alleymainte_2007,			in::road::area_flag::year_2007},
	{-1, -1}
};
