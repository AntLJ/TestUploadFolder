...
class Connection
{
   public :
      ...
      virtual MetaData getMetaData(const RefAny &ref) const
         =0; 
      virtual CharSet getClientCharSet() const 
         =0; 
      virtual CharSet getClientNCHARCharSet() const 
         =0; 
...
class Statement	
{
 public:
  ...
  virtual void setCharSet(unsigned int paramIndex, CharSet charSet) = 0; 
  
  virtual CharSet getCharSet(unsigned int paramIndex) const = 0; 
...
class ResultSet	
{
 public:
  ...
  virtual void setCharSet(unsigned int colIndex, CharSet charSet) = 0; 
  
  virtual CharSet getCharSet(unsigned int colIndex) const = 0; 
