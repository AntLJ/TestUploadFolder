...
// 設定/取得
	 ...
	 * @retval false 登録失敗
	 */
	bool insert(T& rMember, const HashPoint& cPoint)
	{
	 ...
	 */
	void insert(T& rMember, double dMinX, double dMinY, double dMaxX, double dMaxY)
	{
	 ...
	 */
	void insert(T& rMember, const HashPoint& cMinPoint, const HashPoint& cMaxPoint)
	{
