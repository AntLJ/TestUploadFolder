...
class RelNodeGridController
{
public:
	RelNodeGridController(void) {};
	virtual ~RelNodeGridController(void) {};

	/**
 	 * @brief 初期化
	 * @param[in]  hwnd  関連ノードグリッドのハンドル
	 */
	void init( HWND hwnd);
...
private:
	...
	IVSFlexGridPtr m_RelNodeGrid;	//!< 関連ノードのグリッドコントロール
