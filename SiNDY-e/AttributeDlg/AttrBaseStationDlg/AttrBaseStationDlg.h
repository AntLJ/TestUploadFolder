...
// AttrBaseStationDlg.h : CAttrBaseStationDlg の宣言

#ifndef _ATTRBASESTATIONDLG_
#define _ATTRBASESTATIONDLG_
...
/////////////////////////////////////////////////////////////////////////////
//
// CAttrBaseStationDlg メッセージマップ
//
/////////////////////////////////////////////////////////////////////////////
BEGIN_MSG_MAP(CAttrBaseStationDlg)
...
ALT_MSG_MAP(IDC_COMBO_STATIONCLASS_C)
	MESSAGE_HANDLER(WM_KEYDOWN, OnKeyDown)
	MESSAGE_HANDLER(WM_GETDLGCODE, OnGetDlgCode)
...
/////////////////////////////////////////////////////////////////////////////
	...
	LRESULT OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		m_wnd1.SubclassWindow(GetDlgItem(IDC_COMBO_STATIONCLASS_C));
	...
	LRESULT OnCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		if( ( nTargetControl == IDC_COMBO_STATIONCLASS_C ) && ( msg == CBN_SELCHANGE) )
			ShowGenkouByBackgroundClass();

		// 原稿番号入力の値が変わったときに、背景種別のコンボボックスの値を変える
		if( ( nTargetControl == IDC_EDIT_GENKOU )   && ( msg == EN_KILLFOCUS ))
			SetBackgroundClassCode(IDC_EDIT_GENKOU, IDC_COMBO_STATIONCLASS_C);
