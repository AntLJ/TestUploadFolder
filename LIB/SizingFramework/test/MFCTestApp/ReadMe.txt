================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MFCTestApp プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MFCTestApp には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MFCTestApp アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
MFCTestApp.h
   ...
   CMFCTestAppApp アプリケーション クラスを宣言します。

MFCTestApp.cpp
   これは、アプリケーション クラス CMFCTestAppApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MFCTestApp.ico
   ...
   アイコンはメイン リソース ファイル MFCTestApp.rc に含まれていま
   す。
...
MFCTestAppDlg.h, MFCTestAppDlg.cpp - ダイアログ
   これらのファイルは CMFCTestAppDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MFCTestApp.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MFCTestApp.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
