...
// DRMABaseRoadLinkAttr.cpp: DRMABaseRoadLinkAttr クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
const int DRMABaseRoadLinkAttr::sRecordId = drma::kBaseRoadLinkAttrId;

//////////////////////////////////////////////////////////////////////
// 構築/消滅
//////////////////////////////////////////////////////////////////////

DRMABaseRoadLinkAttr::DRMABaseRoadLinkAttr(const Format& cOriginalRecord)
{
...
void DRMABaseRoadLinkAttr::append(const Format& cOriginalRecord)
{
	assert(eContinue != 0);
...
void DRMABaseRoadLinkAttr::appendAttrs(const Format& cOriginalRecord)
{
...
// DRMABaseRoadLinkAttr::Attr クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////

DRMABaseRoadLinkAttr::Attr::Attr(const Format& cOriginal)
{
...
// DRMABaseRoadLinkAttr::Attr2 クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////

DRMABaseRoadLinkAttr::Attr2::Attr2(const Format& cOriginal)
{
	PREPARE_SET_VALUE(cOriginal);
