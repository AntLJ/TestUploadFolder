...
// AttributeTool.cpp : DLL エクスポートのインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f AttributeToolps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_AttributeToolObj, CAttributeToolObj)
OBJECT_ENTRY(CLSID_AttributeToolProp, CAttributeToolProp)
OBJECT_ENTRY(CLSID_AttributeToolPropLQ, CAttributeToolPropLQ)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_ATTRIBUTETOOLLib);
