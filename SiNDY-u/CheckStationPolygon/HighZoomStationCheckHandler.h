...
/**
 * @brief   駅詳細ポリゴン(HIGHZOOM_STATION)のチェック管理クラス
 */
class HighZoomStationCheckHandler : public CheckHandler
{
public:
	HighZoomStationCheckHandler(void){}
	~HighZoomStationCheckHandler(void){}
	 ...
	 * @return  テーブル名
	 */
	virtual uh::tstring getTarget() const override { return sindy::schema::sj::highzoom_station::kTableName; }
