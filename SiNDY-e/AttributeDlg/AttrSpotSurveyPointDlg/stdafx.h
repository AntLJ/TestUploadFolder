...
// SiNDY用スポット現調ビューアの管理者となるドッカブルウィンドウ
extern "C" const GUID __declspec(selectany) CLSID_SpotAttributeWindow = {0x30654A10,0x896B,0x4A91,{0xB2,0x5C,0x84,0xEE,0x68,0x21,0x6E,0x18}};
