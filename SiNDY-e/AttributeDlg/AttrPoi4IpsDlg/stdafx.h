...
// schemaライブラリで使用
#define _SINDYK_SUPPORT_COMMON_RELATION
#include "libschema.h"
...
// コードが文字列型の為Masterテーブル
// std::map<シーケンス, std::pair<IPコード, 名称>>
typedef std::map<long, std::pair<CString, CString>> StringMasterTbl;
