...
#ifndef YY_JSON_PARSER_HPP_INCLUDED
# define YY_JSON_PARSER_HPP_INCLUDED
...
#line 73 "parser.hpp" // lalr1.cc:371
  ...
  public:
    ...
    union union_type
    {
      ...
      // elements
      // value
      char dummy1[sizeof(JsonValuePtr)];
...
#else
    typedef JSONSTYPE semantic_type;
#endif
    /// Symbol locations.
  ...
  basic_symbol (typename Base::kind_type t, const JsonValuePtr v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_O_START (const location_type& l);

    static inline
    symbol_type
    make_O_END (const location_type& l);

    static inline
    symbol_type
    make_A_START (const location_type& l);

    static inline
    symbol_type
    make_A_END (const location_type& l);
    ...
    static inline
    symbol_type
    make_J_NULL (const location_type& l);
    ...
    static inline
    symbol_type
    make_LONGINTEGER (const long long& v, const location_type& l);
    ...
    Parser (class Driver& driver_yyarg, class Scanner& lexer_yyarg);
    virtual ~Parser ();
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 21: // elements
      case 22: // value
        value.copy< JsonValuePtr > (other.value);
        break;
  ...
  template <typename Base>
  Parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const JsonValuePtr v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  Parser::basic_symbol<Base>::~basic_symbol ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 21: // elements
      case 22: // value
        value.template destroy< JsonValuePtr > ();
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 21: // elements
      case 22: // value
        value.move< JsonValuePtr > (s.value);
        break;
  ...
  Parser::symbol_type
  Parser::make_O_START (const location_type& l)
  {
    return symbol_type (token::TOK_O_START, l);

  }

  Parser::symbol_type
  Parser::make_O_END (const location_type& l)
  {
    return symbol_type (token::TOK_O_END, l);

  }

  Parser::symbol_type
  Parser::make_A_START (const location_type& l)
  {
    return symbol_type (token::TOK_A_START, l);

  }

  Parser::symbol_type
  Parser::make_A_END (const location_type& l)
  {
    return symbol_type (token::TOK_A_END, l);
  ...
  Parser::symbol_type
  Parser::make_J_NULL (const location_type& l)
  {
    return symbol_type (token::TOK_J_NULL, l);
  ...
  Parser::symbol_type
  Parser::make_LONGINTEGER (const long long& v, const location_type& l)
  {
    return symbol_type (token::TOK_LONGINTEGER, v, l);
...
#line 1115 "parser.hpp" // lalr1.cc:371




#endif // !YY_JSON_PARSER_HPP_INCLUDED
