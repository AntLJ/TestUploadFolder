...
/**
 * @brief  詳細ポリゴン(STATION_DETAIL)のチェック管理クラス
 */
class StationDetailCheckHandler : public CheckHandler
{
public:
	StationDetailCheckHandler(void){}
	~StationDetailCheckHandler(void){}
	 ...
	 * @return  テーブル名
	 */
	virtual uh::tstring getTarget() const override { return sindy::schema::sj::station_detail::kTableName; }
