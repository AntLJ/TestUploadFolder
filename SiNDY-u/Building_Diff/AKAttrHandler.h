               ...
               long cCorridor )  ///< [in] 渡り廊下フラグ
{
	...
	case	building::bld_class::kPedestrianDeck: return 1; // ペデストリアンデッキ
	case	building::bld_class::kFootBridge: return 1;     // 歩道橋
	case	21: return -1; // 歩道橋階段(削除種別)
	case	22: return -1; // 歩道橋エスカレータ(削除種別)
	case	building::bld_class::kPedestrianDeckStairsEscalator: return 1; // ペデストリアンデッキ階段（階段・エスカレータ）
