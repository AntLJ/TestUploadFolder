...
// LQAttrBywayDlg.h : CLQAttrBywayDlg の宣言

#ifndef __LQATTRBYWAYDLG_H_
#define __LQATTRBYWAYDLG_H_
...
/////////////////////////////////////////////////////////////////////////////
//
// CLQAttrBywayDlg メッセージマップ
//
/////////////////////////////////////////////////////////////////////////////
BEGIN_MSG_MAP(CLQAttrBywayDlg)
	MESSAGE_HANDLER(WM_INITDIALOG, OnInitDialog)
	MESSAGE_HANDLER(WM_COMMAND, OnCommand)
	CHAIN_MSG_MAP(LQATTR_COMMON_BASE_CLASS)

ALT_MSG_MAP(IDC_CHECK_NUKEMITI)
	MESSAGE_HANDLER(WM_KEYDOWN, OnKeyDown)
	MESSAGE_HANDLER(WM_GETDLGCODE, OnGetDlgCode)
ALT_MSG_MAP(IDC_CHECK_URAMITI)
	MESSAGE_HANDLER(WM_KEYDOWN, OnKeyDown)
	MESSAGE_HANDLER(WM_GETDLGCODE, OnGetDlgCode)
...
/////////////////////////////////////////////////////////////////////////////
	...
	LRESULT OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		// サブクラス化
		m_wndNuke.SubclassWindow(GetDlgItem(IDC_CHECK_NUKEMITI));
		m_wndUra.SubclassWindow(GetDlgItem(IDC_CHECK_URAMITI));
...
/////////////////////////////////////////////////////////////////////////////
//
// CLQAttrBywayDlg メンバ変数定義
//
/////////////////////////////////////////////////////////////////////////////
private:
	CLoadQueueInfo		m_cLQInfo;
	CContainedWindow	m_wndUra, m_wndNuke, m_wndSource, m_wndSourceName;
	ISiNDYRulePtr		m_ipRule;			//!< 作業目的DB対応
	HWND				m_hChildWnd;		//!< 子ダイアログハンドル

};

#endif //__LQATTRBYWAYDLG_H_
