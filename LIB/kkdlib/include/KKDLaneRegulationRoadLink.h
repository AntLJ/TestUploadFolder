...
// KKDLaneRegulationRoadLink.h: KKDLaneRegulationRoadLink クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////
...
public:
// 定義
	typedef KKDIntersectionId IntersectionId; ///< 交差点番号
