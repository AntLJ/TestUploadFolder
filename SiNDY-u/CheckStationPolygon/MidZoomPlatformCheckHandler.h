...
/**
 * @brief   プラットフォームポリゴン(MIDZOOM_PLATFORM)のチェック管理クラス
 */
class MidZoomPlatformCheckHandler : public CheckHandler
{
public:
	MidZoomPlatformCheckHandler(void){}
	~MidZoomPlatformCheckHandler(void){}
	 ...
	 * @return  テーブル名
	 */
	virtual uh::tstring getTarget() const override { return sindy::schema::sj::midzoom_platform::kTableName; }
