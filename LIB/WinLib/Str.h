...
#ifndef __STR_CLASS_H__
#define __STR_CLASS_H__

#pragma once

#pragma message("memo : Str.hはインクルードせず、代わりにatlstr.hを使用して下さい。")

#if _ATL_VER >= 0x0800
#include <atlstr.h> // VC8 ATLで定義されているものを使用します
...
#endif // ifndef _ATL_USE_CSTRING_FLOAT
...
// Attributes & Operations
	...
	bool Compare2(LPCTSTR lpsz) const;
	...
	int Find(LPCTSTR lpszSub, int nStart) const;        // like "C" strstr
...
/////////////////////////////////////////////////////////////////////////////
//
// http://hp.vector.co.jp/authors/VA016589/wtl/bugs/bugs.html
//
// Bug Patch: int CString::Find( LPCTSTR pstr) const;　が遅い。
//            pStrを使うのを忘れて、全てのバイトで文字列比較を行っているように見えます。
//
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// deleted
...
// added
	static TCHAR* _cstrstr(const TCHAR* pStr, const TCHAR* pCharSet)
	{
		...
		while((pStr = _cstrchr(pCur, *pCharSet)) != NULL)
		{
			if(memcmp(pStr, pCharSet, nLen * sizeof(TCHAR)) == 0)
			{
				pRet = pStr;
				break;
			}
...
#endif //!_SINDY_NO_CSTRING

#endif // if _ATL_VER >= 0x0800

#endif // __STR_CLASS_H__
