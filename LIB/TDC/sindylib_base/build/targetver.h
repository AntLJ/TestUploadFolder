...
#ifndef WINVER                  // 最低限必要なプラットフォームが Windows XP であることを指定します。
#define WINVER 0x0501           // これを Windows の他のバージョン向けに適切な値に変更してください。
#endif

#ifndef _WIN32_WINNT            // 最低限必要なプラットフォームが Windows XP であることを指定します。
...
#ifndef _WIN32_IE               // 最低限必要なプラットフォームが Internet Explorer 6.0 であることを指定します。
