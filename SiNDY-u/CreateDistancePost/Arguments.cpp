...
namespace sindy
{
	...
	const char * k_roadlist =   "road_list";       ///< 対象路線リストファイルパス
	const char * k_pitch =      "pitch";           ///< ピッチ
	const char * k_outdir =     "out_dir";         ///< 作業ログ出力パス
	const char * k_roadclass =  "roadclass_cost";  ///< 道路種別コスト定義ファイルパス
	const char * k_linkclass =  "linkclass_cost";  ///< リンク種別コスト定義ファイルパス
