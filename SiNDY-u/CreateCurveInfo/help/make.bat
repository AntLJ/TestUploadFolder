...
set RELFILENAMEPOSTFIX=(release)

set PROJECTNAME=%PROJECTNAMERC:~31,-1%
set FILEVERSION=%FILEVERSIONRC:~13%
set PRODUCTVERSION=%PRODUCTVERSIONRC:~16%

set HELPBASEFILENAME=%FILENAMERC:~35,-1%
set RELEASEFILENAME=%HELPBASEFILENAME%%RELFILENAMEPOSTFIX%
set DEVFILENAME=%HELPBASEFILENAME%
