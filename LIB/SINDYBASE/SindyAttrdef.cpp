...
/**
 *	SindyAttrdef.cpp : ëÆê´íËã`èâä˙íl
 */
...
std::string sindy::layer::INF_IPCVICS = "inf_ipcvics";
...
std::string sindy::layer::INF_INTERSECION = "inf_intersection";
...
std::string sindy::layer::LQ_IPCVICS = "lq_ipcvics";
...
std::string sindy::layer::LQ_INTERSECTION = "lq_intersection";
...
std::string sindy::layer::ACCESS_STORE = "access_store";
std::string sindy::layer::ETC_TOLLGATE = "etc_tollgate";
...
std::string sindy::road_link::WIDEAREA_F = "widearea_f";
...
std::string sindy::road_link::INTERSECTION_LQRF = "intersection_lqrf";
std::string sindy::road_link::IPCVICS_LQRF = "ipcvics_lqrf";
...
std::string sindy::access_point::GS_F = "gs_f";
std::string sindy::access_point::MULTIPLESTORE_F = "multiplestore_f";
std::string sindy::access_point::DOGRUN_F = "dogrun_f";
...
std::string sindy::access_point::SAPAINFO3[] = {
	sindy::access_point::GS_F,
	sindy::access_point::HANDICAP_F,
	sindy::access_point::RESTAURANT_F,
	sindy::access_point::SOUVENIR_F,
	sindy::access_point::RESTING_F,
	...
	sindy::access_point::INFORMATION_F,
	sindy::access_point::HWYOASIS_F,
	sindy::access_point::MULTIPLESTORE_F,
	sindy::access_point::DOGRUN_F,
	""
};
...
std::string sindy::facil_info_point::SEARCHCLASS_C = "searchclass_c";
std::string sindy::facil_info_point::AUTOPOSITION_F = "autoposition_f";
std::string sindy::facil_info_point::DUMMYFACIL_F = "dummyfacil_f";
...
std::string sindy::highway_node::NOETC_CAR_F = "noetc_car_f";
std::string sindy::highway_node::TOLLFUNC_C = "tollfunc_c";
std::string sindy::highway_node::DUMMYTOLL_F = "dummytoll_f";

std::string sindy::highway_node::ETC_FACIL_C = "etc_facil_c";
std::string sindy::highway_node::ETC_TOLLFUNC_C = "etc_tollfunc_c";
std::string sindy::highway_node::ETC_NOGUIDETOLL_F = "etc_noguidetoll_f";
std::string sindy::highway_node::TOLLGATE_ID = "tollgate_id";
...
std::string sindy::highway_node::TOLLGATE_LANE = "tollgate_lane";
...
std::string sindy::highway_text::FORE1_DIR_C = "fore1_dir_c";
std::string sindy::highway_text::FORE2_DIR_C = "fore2_dir_c";
std::string sindy::highway_text::FORE3_DIR_C = "fore3_dir_c";
std::string sindy::highway_text::FORE4_DIR_C = "fore4_dir_c";
...
std::string sindy::highway_text::BACK1_DIR_C = "back1_dir_c";
std::string sindy::highway_text::BACK2_DIR_C = "back2_dir_c";
std::string sindy::highway_text::BACK3_DIR_C = "back3_dir_c";
std::string sindy::highway_text::BACK4_DIR_C = "back4_dir_c";
...
std::string sindy::highway_text::FORDIR[] = {
	sindy::highway_text::FORE1_DIR_C,
	sindy::highway_text::FORE2_DIR_C,
	sindy::highway_text::FORE3_DIR_C,
	sindy::highway_text::FORE4_DIR_C,
	""
};
...
std::string sindy::highway_text::BACKDIR[] = {
	sindy::highway_text::BACK1_DIR_C,
	sindy::highway_text::BACK2_DIR_C,
	sindy::highway_text::BACK3_DIR_C,
	sindy::highway_text::BACK4_DIR_C,
	""
};
...
std::string sindy::inf_guide::DELETE_F = "delete_f";
std::string sindy::inf_guide::ATTR[] = {
	sindy::inf_guide::GUIDETYPE_C,
	sindy::inf_guide::DELETE_F,
	""
};
...
std::string sindy::inf_intersection::NAME_KANJI = "name_kanji";
std::string sindy::inf_intersection::NAME_YOMI = "name_yomi";
std::string sindy::inf_intersection::ATTR[] = {
	sindy::inf_intersection::NAME_KANJI,
	sindy::inf_intersection::NAME_YOMI,
	""
};
...
std::string sindy::road_code_list::DISPLAY_KANJI = "display_kanji";
std::string sindy::road_code_list::DISPLAY_YOMI = "display_yomi";
std::string sindy::road_code_list::SHIELD_NO_STRING = "shield_no_string";
std::string sindy::road_code_list::ATTR[] = {
	...
	sindy::road_code_list::DISPLAY_KANJI,
	sindy::road_code_list::DISPLAY_YOMI,
	sindy::road_code_list::SHIELD_NO_STRING,
	""
};
...
std::string sindy::time_nopassage::SEASONREG_F = "seasonreg_f";
...
std::string sindy::access_store::ACCESSPOINT_ID = "accesspoint_id";
std::string sindy::access_store::MULTIPLESTORE_C = "multiplestore_c";
std::string sindy::access_store::START_HOUR = "start_hour";
std::string sindy::access_store::START_MIN = "start_min";
std::string sindy::access_store::END_HOUR = "end_hour";
std::string sindy::access_store::END_MIN = "end_min";
std::string sindy::access_store::SUNDAY_F = "sunday_f";
std::string sindy::access_store::MONDAY_F = "monday_f";
std::string sindy::access_store::TUESDAY_F = "tuesday_f";
std::string sindy::access_store::WEDNESDAY_F = "wednesday_f";
std::string sindy::access_store::THURSDAY_F = "thursday_f";
std::string sindy::access_store::FRIDAY_F = "friday_f";
std::string sindy::access_store::SATURDAY_F = "saturday_f";
std::string sindy::access_store::BON_F = "bon_f";
std::string sindy::access_store::YEAREND_F = "yearend_f";
std::string sindy::access_store::NEWYEAR_F = "newyear_f";
std::string sindy::access_store::GOLDENWEEK_F = "goldenweek_f";
std::string sindy::access_store::HOLIDAY_F = "holiday_f";
std::string sindy::access_store::STORETYPE_C = "storetype_c";

std::string sindy::etc_tollgate::TOLLGATE_ID = "tollgate_id";
std::string sindy::etc_tollgate::TOLLGATE_PARENT_ID = "tollgate_parent_id";
std::string sindy::etc_tollgate::TOLLGATE_OFFICE_ID = "tollgate_office_id";
std::string sindy::etc_tollgate::TOLLGATE_OFFICE_NAME = "tollgate_office_name";
std::string sindy::etc_tollgate::TOLLGATE_ROAD_NUMBER = "tollgate_road_number";
std::string sindy::etc_tollgate::TOLLGATE_ROAD_NAME = "tollgate_road_name";
std::string sindy::etc_tollgate::TOLLGATE_IC_NUMBER = "tollgate_ic_number";
std::string sindy::etc_tollgate::TOLLGATE_IC_NAME = "tollgate_ic_name";
std::string sindy::etc_tollgate::TOLLGATE_IC_NAME_YOMI = "tollgate_ic_name_yomi";
std::string sindy::etc_tollgate::TOLLGATE_FLAG = "tollgate_flag";
std::string sindy::etc_tollgate::TOLLGATE_OTHER = "tollgate_other";
